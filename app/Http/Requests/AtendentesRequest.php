...
class AtendentesRequest extends FormRequest {
	...
	public function messages(){
        ...
        return [ 
            ...
            'tipo_sanguineo.required'=>'O campo Tipo Sanguíneo deve ser preenchido.',
            'fator_rh.required'=>'O campo Fator RH deve ser preenchido.',
            ...
            'carteira.max'=>'O campo Carteira de Trabalho deve possuir no máximo 18 caracteres.',
            'cnpj.max'=>'O campo CNPJ deve possuir no máximo 14 caracteres.',
        ];
    }
