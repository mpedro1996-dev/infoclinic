...
class CreateModelRegistrosRegionalEspecialidades extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registros_regional_especialidades', function (Blueprint $table) {
            ...
            $table->unique(['registros_regional_id','especialidade_id'],'registros_regional_especialidade_unique');
